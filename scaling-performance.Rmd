...
These values are also used to determine the reactive dependencies, much like the *first* argument of `observeEvent()` or `evenReactive()`.
...
As well as inputs, you can use other `reactive()`s as cache keys, but you'll need to keep them as a simple as possible (i.e. atomic vectors, or simple lists of atomic vectors).
