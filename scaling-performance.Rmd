...
There are four techniques that seem to help many Shiny apps seen in the wild: considering data import, pulling out expensive preprocessing into a separate step, sharing work across users with caching, and carefully managing user expectations.
...
[^scaling-performance-6]: See [<https://ursalabs.org/blog/2020-feather-v2/>](https://ursalabs.org/blog/2020-feather-v2/){.uri} for some benchmarks.
