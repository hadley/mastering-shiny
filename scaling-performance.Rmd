...
If this is expensive and needs to happen regularly because the data is changing, you should consider using a cron job, scheduled RMarkdown report, or similar, to perform the expensive operations and save the results.
