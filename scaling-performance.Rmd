...
(Unless you learn about async programming, which basically lets R work on multiple things at the same time [\<[https://rstudio.github.io/promises/\>](https://rstudio.github.io/promises/>)](https://rstudio.github.io/promises/){.uri}).
...
-   Make it faster for a single user.
    ...
    Some advice in [\<[https://adv-r.hadley.nz/perf-measure.html\>](https://adv-r.hadley.nz/perf-measure.html\>)](https://adv-r.hadley.nz/perf-measure.html){.uri} and [\<[https://adv-r.hadley.nz/perf-improve.html\>](https://adv-r.hadley.nz/perf-improve.html\>)](https://adv-r.hadley.nz/perf-improve.html){.uri}.
