...
* Like outputs, reactive expressions depend on inputs and are updated 
  automatically when the inputs change. 
...
TODO: draw out as three separate diagrams. Or draw boxes and allude to modules?
...
```{r, eval = FALSE}
params1 <- debounce(
  reactive(list(input$n_1, input$mean_1, input$sd_1)),
  250
)
x1 <- eventReactive(params1,
