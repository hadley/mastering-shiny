...
As well as updating the content of the outputs, sometimes you will actually want to add more, or modify the inputs, or generally change the apperance of the UI with code. This techniques should be used sparingly, because add substantially more complexity to your app, but when you need them, you need them.

In Chapter XYZ, we'll come back to more advanced tecnhiques (including `conditionalPanel()`, `insertUI()`, and `removeUI()`) that require you know a little more HTML/CSS/JS.
