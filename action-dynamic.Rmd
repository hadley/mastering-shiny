...
```{r update-basics, fig.cap = "The app on load (left), after increasing max (middle), and then decreasing min (right).", out.width = "33%", fig.show = "hold", fig.align = "default", echo = FALSE, message = FALSE, cache = FALSE}
