...
So far, we've seen a clean separation between the user interface and the server function: the user interface is defined statically when the app is launched so it can't respond to anything that happens in the app. In this chapter, you'll learn how to create __dynamic__ user interfaces, changing the UI using code run in the server function. 

There are three key techniques for creating dynamic user interfaces:

* Using the `update` family of functions to modify parameters of input
  controls.
