...
(Note the use of the `switch_page()` function to reduce the amount of duplication in the server code. We'll come back to this idea in Chapter \@ref(scaling-functions).)
