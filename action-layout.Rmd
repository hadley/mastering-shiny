...
-   You can use the `class` argument to customise some layouts, inputs, and outputs using Bootstrap class names, Section \@ref(custom-classes).

-   You can make your own functions to generate Bootstrap components that Shiny doesn't provide, Section \@ref(new-components).
...
-   supply additional `class` Some components allow you to supply additional CSS classes to style app components.
