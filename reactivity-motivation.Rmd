...
In this part of the book, you'll dive into the details of reactivity:

-   In this chapter, you'll learn why reactivity is necessary, and a little bit about the history of reactive programming outside of R.

-   In Chapter \@ref(dependency-tracking), you'll learn more about how reactivity works underneath the covers.

-   Chapter \@ref(scoping) goes into the details of object lifetimes including how you can share data across users, and how and why you might create an app within a function.

-   In Chapter \@ref(reactivity-components), you'll learn more about the data structures that underlying reactive programming, and how you can compose them to solve new problems.
