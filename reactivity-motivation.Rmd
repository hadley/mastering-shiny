...
Now we can show you some real Shiny code, using a special Shiny mode, `reactiveConsole(TRUE)`, that enables reactivity in the console so you can experiment with it directly.
