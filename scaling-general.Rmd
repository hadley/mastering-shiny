...
The goal of this part of the book is to teach you the most important software engineering principles that will help you build robust, ..., apps. The most important topics are covered in the subsequent chapters, but some parts are just too big for this book, and you'll need to learn more elsewhere.
...
Git is one such tool that is popular in the R community. There is admittedly a learning curve involved before you can become proficient (or even comfortable), but any experienced developer will confirm that the effort required is well worth it. [_Happy Git and GitHub for the useR_](https://happygitwithr.com/), by Jenny Bryan, is a great resource prepared specifically for R users to become familiar with Git.
