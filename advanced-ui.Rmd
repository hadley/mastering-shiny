...
In the following section we explore amazing helper functions, such as `tagAppendChild()` from htmltools.
...
The [brighter](https://github.com/ThinkR-open/brighter) package written by Colin Fay contains very neat functions to edit your tags. Particularly, the `tagRemoveAttributes()`
