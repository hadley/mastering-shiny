...
* Section \@ref(primitives) (re-)introduces you to the three main building blocks of reactive programming: reactive values, reactive expressions and observers/outputs.
...
## (Re-)Introducing reactive programming {#motivation}
