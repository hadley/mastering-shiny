...
Unfortunately, magic in software usually leads to disillusionment. Without a solid mental model to reason with, it's extremely difficult to know how the software will react when you venture beyond its demos and examples. And when things don't go the way you expect, debugging is almost impossible.
