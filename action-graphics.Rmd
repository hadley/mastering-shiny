...
You can also call `thematic_on()` as below to attempt to automatically determine all of the settings from the theme assoicated with your Shiny app.

```{r, eval = FALSE}
thematic_on(font = "auto")
```

<https://rstudio.github.io/thematic/articles/Shiny.html>
