...
The direction might surprise you, as it's easy to think of a consumer taking a dependencies on one or more producers.
...
While those arrows represent notifications that haven't yet fired, the invalidated node no longer cares about them: reactive consumers only care notifications in order to invalidate themselves and that that has already happened.
