...
### Expressing HTML in R, with htmltools
...
To write any other tags, you need to prefix the tag name with `tags$`. For example, to create a `<ul>` tag, you can call `tags$ul()`. The `tags` object is a named list that htmltools provides, and it comes preloaded with almost all of the valid tags in the HTML standard.
