...
* Existing Shiny uses who want to improve their knowledge of the theory
...
cat("A big thank you to all ", nrow(contributors), " people who contributed specific improvements via pull requests (in alphabetical order by username): ", sep = "")
...
The following ruler is used to check code width.
