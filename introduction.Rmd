...
Shiny makes it signficantly the R programmer to create web apps by:
...
* Providing a carefully curated set of user interface (**UI** for short)
  ...
  common tasks. This means that you don't know need to know the details of 
...
* Replace hundreds of pages of PDFs with interactive apps that allow the 
  user to jump to the exact slice of the that they care about.
...
* Provide self-serve data analysis for common workflows where replacing 
...
1.  "Mastering UI" dives into the details of the user interface. You'll learn 
    ...
    RStudio gadges, then learn the basics of HTML and CSS so you can customise 
