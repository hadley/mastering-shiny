...
-   Providing a carefully curated set of user interface (**UI** for short) functions that generate the HTML, CSS, and JavaScript that needed for common tasks.
...
There are also a number of important topics specific to Shiny that we don't cover:

-   UI toolkits.

-   Deployment Shiny apps.
