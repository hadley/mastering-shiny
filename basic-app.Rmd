...
2.  Extend the app from the previous exercise to allow the user to set the value of the 
...
3.  Replace the UI and server components of your app from the previous exercise 
...
4.  The following app is very similar to one you've seen earlier in the chapter: 
