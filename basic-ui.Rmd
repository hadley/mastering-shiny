...
ui_screenshot(ui, "basic-ui/free-text", height = 150)
```
...
```
```{r, echo = FALSE, output.width = NULL}
ui_screenshot(ui, "basic-ui/numeric", height = 300)
```
...
```
```{r, echo = FALSE, output.width = NULL}
ui_screenshot(ui, "basic-ui/limited-choices", height = 300)
```
...
```
```{r, echo = FALSE, output.width = NULL}
ui_screenshot(ui, "basic-ui/radio-icon", height = 150)
```
...
app_screenshot(app, "basic-ui/limited-choices-multi", height = 400)
```
