...
One of the key features of tidy evaluation is the idea of **data masting** which blurs the line between two meanings of "variable":
...
[^fun-scoping]: And because of R's scoping rules, all function calls are found in the 
