...
[^2]: There's another form of indirection that happens when you're writing functions which is solved using `{{ x }}`, called embracing. You can learn more about that in *[Programming with dplyr](http://dplyr.tidyverse.org/dev/articles/programming.html)*.
