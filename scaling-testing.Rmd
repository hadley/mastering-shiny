...
Testing is a way to capture the desired behaviour of your code to work, and turn it into an automated tool that allows you to verify that your code keeps working the way that you expect.
