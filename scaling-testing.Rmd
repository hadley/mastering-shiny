...
For simple apps, it's easy enough to remember how the app is supposed to work, so that when you make changes to add new features, you don't accidental break existing capabilities.
...
-   `testServer()` ignores UI.
    ...
    Most importantly this means that you can't test the `update*` functions, because they work by sending JavaScript to the browser to simulate user interactions.
