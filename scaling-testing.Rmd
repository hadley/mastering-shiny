...
This chapter uses features in the upcoming releases of shiny 1.5.1, testthat 3.0.0, and shinytest 1.5.0, so if you're reading the book now you'll need to install their development versions from GitHub with `remotes::install_github(c("r-lib/testhat", "rstudio/shinytest", "rstudio/shiny))`.
...
But I think you move past this fairly quickl
