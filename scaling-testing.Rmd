...
This chapter uses new features in testthat 3.0.0 and shinytest 1.5.0, so you'll need to have those versions or higher installed.
...
```{r, include = FALSE}
# remove customised shinyApp() which causes the following chunk to fail
# for unknown reasons
rm("shinyApp")
```
