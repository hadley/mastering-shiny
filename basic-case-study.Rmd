...
You can see the code I used to create the extract for this chapter at [<https://github.com/hadley/mastering-shiny/blob/master/neiss/data.R>](https://github.com/hadley/mastering-shiny/blob/master/neiss/data.R){.uri}.
