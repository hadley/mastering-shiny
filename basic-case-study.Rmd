...
A screenshot of resulting app is shown in Figure \@ref(fig:prototype). You can find the source code at <https://github.com/jcheng5/shiny-book/tree/master/neiss>, and try out a live version of the app at XYZ.
