...
-   If you want to start a new project[^action-workflow-2], go to the File menu, select "New Project" then select "Shiny Web Application":
...
You can run this function interactively to see the sequence of calls that lead to an error, *after* the error has occurred.
