...
I decided to use the first form[^3] because I think it's the most explicit, and has the pleasant side-effect of reducing the duplication in my code. I then double-checked that this had the result I expected:
...
When I try to help someone with their app on [RStudio community](https://community.rstudio.com/tag/shiny), creating a reprex is always the first thing I do. This isn't some make work exericse I use to fob off people I don't want to help: it's exactly where I start!
