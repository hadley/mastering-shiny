...
There's one last building block to discuss. It's a little different to the others in this chapter because it's not a type of object, but is instead a special behaviour: timed invalidation.
...
Now we'll turn out attention to a specific combination of reactive values and observers that allows us to escape some of the constraints (for better and worse) of the reactive graph.
